...
## Installation
    ...
    cordova plugin add @mobisys-internal/cordova-plugin-camera
...
The variable is configured on install time
    ...
    cordova plugin add @mobisys-internal/cordova-plugin-camera --variable ANDROIDX_CORE_VERSION=1.8.0
